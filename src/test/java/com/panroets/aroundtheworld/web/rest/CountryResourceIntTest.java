...
import com.panroets.aroundtheworld.repository.CountryRepository;
import com.panroets.aroundtheworld.service.dto.CountryDTO;
import com.panroets.aroundtheworld.service.mapper.CountryMapper;
...
public class CountryResourceIntTest {
    ...
    private static final String DEFAULT_PATH_SVG_FORMAT = "AAAAAAAAAA";
    private static final String UPDATED_PATH_SVG_FORMAT = "BBBBBBBBBB";
    ...
    public static Country createEntity() {
        Country country = new Country()
            ...
            .pathSvgFormat(DEFAULT_PATH_SVG_FORMAT);
        return country;
    }
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getPathSvgFormat()).isEqualTo(DEFAULT_PATH_SVG_FORMAT);
    }
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].pathSvgFormat").value(hasItem(DEFAULT_PATH_SVG_FORMAT.toString())));
    }
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.pathSvgFormat").value(DEFAULT_PATH_SVG_FORMAT.toString()));
    }
    ...
    public void updateCountry() throws Exception {
        ...
        updatedCountry
            ...
            .pathSvgFormat(UPDATED_PATH_SVG_FORMAT);
        ...
        assertThat(testCountry.getPathSvgFormat()).isEqualTo(UPDATED_PATH_SVG_FORMAT);
    }
